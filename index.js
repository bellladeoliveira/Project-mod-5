...
const propriedade = [] 
// Cria um array vazio para armazenar as entradas do usuário.
let input = "" 
// Inicializa a variável de entrada como uma string vazia
...
while (input != "sair"){
     // Laço while que executa enquanto a entrada não for "sair"
    adicionarNaLista()
